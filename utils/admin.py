...
def create_tables():
    ...
    create_user_diagnostics = "CREATE TABLE IF NOT EXISTS user_diagnostics (username STRING NOT NULL, gender STRING NOT NULL, age STRING NOT NULL, height REAL NOT NULL, weight REAL NOT NULL);"
